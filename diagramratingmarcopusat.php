...
$bulan= date('m');
  $tahun= date('Y');
  $no=1;
  $jumlah= "SELECT rating, COUNT( * ) AS total FROM ratingmarcociputat GROUP BY rating"; 
  $rata2= "SELECT AVG(rating) AS ratarata from ratingmarcociputat";
...
<head>
	...
	function drawChart() {
		...
		var chart = new google.visualization.BarChart(document.getElementById('chart_ratingmarcopusat'));
...
<body>
    ...
    <div id="chart_ratingmarcopusat"></div>
	<div>
