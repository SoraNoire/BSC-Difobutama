...
$(document).ready(function() {
    $('#analistabel2').DataTable();
} );
</script>
<script type="text/javascript">
$(document).ready(function() {
    $('#sliknonpadpk2').DataTable();
} );
</script>
</head>
<body>
    ...
    <div>
        <a type="button" class="btn btn-info btn-lg" href="PADPK_Alur_Data_dir_marco.php">Monitoring Pengajuan Kredit Berjalan</a>
    </div>
	...
	FROM data_ao_landing where kode_perusahaan='112' group by nama_ao";
	...
	<tr>
		...
		(SELECT COUNT(*) FROM ao_data_call WHERE month(tanggal)=$bulan and year(tanggal)=$tahun and kantor_user='Marcorindo') AS NJdsacr,
		(SELECT COUNT(*) FROM sales_plan WHERE month(tanggal_sp)=$bulan and year(tanggal_sp)=$tahun and kantor='Marcorindo') AS NJdsar,
		(SELECT COUNT(*) FROM data_slik WHERE month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and status='Yes' and kantor_pemohon='Marcorindo') AS NJSlikyes,
		(SELECT COUNT(*) FROM data_slik WHERE month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and status='No' and kantor_pemohon='Marcorindo') AS NJSlikno,
		(SELECT COUNT(*) FROM data_slik WHERE month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and status='-' and kantor_pemohon='Marcorindo') AS NJSliku,
		(SELECT SUM(plafond) FROM permohonan_analisa_kredit WHERE
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc2' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc' or
        month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='AKproses' or
        month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='AKproses2' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc3' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='revised' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='rejected' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='KAKproses2' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='KAKproses' ) AS NJPDA,
    	(SELECT COUNT(*) FROM permohonan_analisa_kredit WHERE
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc2' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc3' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc' or
    	...
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='KAKproses2' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='rejected' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='KAKproses' ) AS NJTDA,
		(SELECT SUM(plafond) FROM permohonan_analisa_kredit WHERE
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc2' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc3' ) AS NJPDAacc,
    	(SELECT COUNT(*) FROM permohonan_analisa_kredit WHERE
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc2' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc3' or
    	month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_pemohon='Marcorindo' and status='acc' ) AS NJTDAacc,
	    (SELECT SUM(plafond) FROM input_targetao where month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_ao='Marcorindo') AS NJPPC,
    	(SELECT COUNT(*) FROM input_targetao where month(tanggal_input)=$bulan and year(tanggal_input)=$tahun and kantor_ao='Marcorindo') AS NJTPC,
	    (SELECT SUM(plafond) FROM input_targetao where Year(tanggal_input)=$tahun and kantor_ao='Marcorindo' ) AS NJPTPC,
    	(SELECT COUNT(*) FROM input_targetao where Year(tanggal_input)=$tahun and kantor_ao='Marcorindo' ) AS NJTTPC
	...
	<div class="table-responsive">
	<table id="analistabel2" class="table table-responsive" style="font-size:10px">
	<thead>
	...
	FROM permohonan_analisa_kredit where kantor_pemohon='Marcorindo' order by tanggal_input DESC";	
	...
	<div class="table-responsive">
	<table class="table" id="sliknonpadpk2">
	<thead>
	<tr style="border: 2px solid black; text-align: center" align="center">
		<th style="border: 2px solid black;vertical-align: middle; text-align: center"><b>No.</b></th>
	...
	<?php
	$sliknonpadpk= "SELECT * FROM data_slik WHERE NOT EXISTS (select nama_nasabah from permohonan_analisa_kredit where data_slik.nama_nasabah=permohonan_analisa_kredit.nama_nasabah) and status='Yes' and kantor_pemohon='Marcorindo' or  NOT EXISTS (select nama_nasabah from permohonan_analisa_kredit where data_slik.nama_nasabah=permohonan_analisa_kredit.nama_nasabah) and status='No' and kantor_pemohon='Marcorindo' ORDER BY tanggal_input DESC";	
	...
	(SELECT COUNT(*) FROM sales_plan WHERE month(tanggal_sp)=$bulan and year(tanggal_sp)=$tahun and nama_karyawan=data_ao_funding.nama_ao  group by data_ao_funding.nama_ao ) AS TTdsarf,
	(SELECT SUM(nominal) FROM input_targetaof WHERE month(tgl_buka)=$bulan and year(tgl_buka)=$tahun and nama_ao=data_ao_funding.nama_ao) AS Tjpasbf,
	(SELECT COUNT(*) FROM input_targetaof WHERE month(tgl_buka)=$bulan and year(tgl_buka)=$tahun and nama_ao=data_ao_funding.nama_ao) AS TjpasbAf,
	...
	FROM data_ao_funding WHERE kode_perusahaan='112' group by nama_ao";	
	...
	FROM data_k_penagihan WHERE kode_perusahaan='112' group by nama_collector";	
	...
	where t1.kantor_user='Marcorindo'
	group by t2.nama_ao" ;
	...
	where t1.kantor='Marcorindo' and t1.media_penagihan='Kunjungan'
	...
	where t1.kantor_pemohon='Marcorindo'
	group by t2.nama_ao" ;
...
<div class="table-responsive">
<?php include('DIREKSIarea_RollBackLaporanmarco.php')?>
<?php include('DIREKSIarea_PerformaAOmarco.php')?>
</div>
</body>
</html>