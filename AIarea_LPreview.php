...
$.ajax({
url: "AIarea_ambilpenempatan.php",
data: "kantor="+kantor,
cache: false,
...
$("#nama_col").html(msg);
	...
	<body>
		...
		$kantor=$row['kantor'];
		?>
		<form action="AIarea_LPreview.php" method="post" name="postform">
...
<tr>
<td>Pilih Nama Col </td>
<td>
<select name="nama_col" id="nama_col">
<option></option>
</select>
</td>
</tr>
		...
		<?php
			...
			<script language="JavaScript">
				...
				document.location='AIarea_LPreview.php';
			</script>
			<?php
			}
			elseif(empty($kode_penempatan) && empty($nama_col)){
			...
			<?php
			$query=mysqli_query($con, "SELECT * FROM laporan_penagihan WHERE kantor='$realkantor' and tanggal_penagihan between '$tanggal_awal' and '$tanggal_akhir'");
			}
			elseif(empty($nama_col)){
			?><i><b>Informasi : </b> Hasil pencarian data berdasarkan periode Tanggal <b><?php echo $_POST['tanggal_awal']?></b> s/d <b><?php echo $_POST['tanggal_akhir']?></b></i>
			<?php
			$query=mysqli_query($con, "SELECT * FROM laporan_penagihan WHERE kantor='$realkantor' and penempatan='$realpenempatan' and tanggal_penagihan between '$tanggal_awal' and '$tanggal_akhir'");
			}	
			else
			{
			?><i><b>Informasi : </b> Hasil pencarian data berdasarkan periode Tanggal <b><?php echo $_POST['tanggal_awal']?></b> s/d <b><?php echo $_POST['tanggal_akhir']?></b></i>
			<?php
			$query=mysqli_query($con, "SELECT * FROM laporan_penagihan WHERE id_kolektor='$nama_col' and tanggal_penagihan between '$tanggal_awal' and '$tanggal_akhir'");
			}
		?>
		</p>
      ...
      <div class="table-responsive" style="width: 100%">
        <table class="table table-bordered" width="100%">
          <tr>
            ...
            <th class="text-center text-nowrap">Nama Collector</th>
            ...
            <th class="text-center text-nowrap">Kolektibilitas</th>
            ...
            <tr style="font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, 'sans-serif'">
              ...
              <td class="align-middle"><a href="<?php echo $data['lokasi_lappenagihan']; ?>" target="_blank">KLICK HERE</a></td>
