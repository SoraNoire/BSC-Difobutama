...
<div class="table-responsive">
	...
	<td style="border: 2px solid black;text-align: center"><a class="btn btn-success" href="DCAR_PM_view_invoice_<?php echo($kantor)?>.php?kode_bayar=<?php echo $datapenagihanmobile['kode_bayar']?>" target="_BLANK">INVOICE</a></td>
	</tr>
	<?php
	$no++;
	}
