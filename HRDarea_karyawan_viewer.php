...
<hr>
	...
	<?php echo "<a href='HRDarea_karyawan_viewer_edit_kepegawaian.php?nik=".$nik."' class='btn btn-info'>Ubah Status Kepegawaian</a>";?>
	<?php echo "<a href='HRDarea_karyawan_viewer_edit_jaminanperusahaan.php?nik=".$nik."' class='btn btn-info'>Ubah Jaminan Perusahaan</a>";?>
	<?php echo "<a href='HRDarea_karyawan_viewer_edit_informasilainnya.php?nik=".$nik."' class='btn btn-info'>Ubah Informasi Lainnya</a>";?>
	<?php echo "<a href='HRDarea_karyawan_viewer_resign.php?nik=".$nik."' class='btn btn-danger'>Karyawan Ini Telah Mengundurkan Diri/Resign</a>";?>
	  </div>
  </div>
<hr>
