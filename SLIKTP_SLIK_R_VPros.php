<div class="table-responsive" border="1" width="100%" style="margin-bottom: 2%">
 <table class="table table-bordered" style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'" width="100%">
  ...
  $no=1;
  $query = "SELECT * FROM data_slik_ao_req WHERE kantor='$kantor' and penempatan='$penempatan' and status='requested' order by tanggal_req,jam_req ASC"; 
  ...
  while($data = mysqli_fetch_array($sql)){
    ...
    echo "<td align='center'><a href='SLIKTP_SLIK_R_Upload.php?id_nasabah=".$data['nik_ktp_nasabah']."' class='btn btn-info'><span class='glyphicon glyphicon-upload'></span></a></td>";
    ...
    echo "<td align='center'><a href='SLIKTP_SLIK_R_Revise.php?id_nasabah=".$data['nik_ktp_nasabah']."' class='btn btn-danger'><span class='glyphicon glyphicon-backward'></span></a></td>";
    echo "</tr>";
