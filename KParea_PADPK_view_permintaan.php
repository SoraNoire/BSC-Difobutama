...
<div class="table-responsive" border="1" width="100%" style="margin-bottom: 20px">
 <table class="table table-bordered" style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'" width="100%">
  ...
  $query = "SELECT * FROM permohonan_analisa_kredit WHERE status='KAKproses' and kantor_kep_analis='$kantor' order by tanggal_input DESC"; 
  ...
  while($data = mysqli_fetch_array($sql)){
    ...
    echo "<td align='center'><a href='KParea_PADPK_viewer.php?kode_permintaan=".$data['kode_permintaan']."' class='btn btn-default'><span class='glyphicon glyphicon-eye-open'></span></a></td>";
    echo "</tr>";
  }
  ?>
	</table>
