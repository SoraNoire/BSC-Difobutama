 ...
 <table class="table table-bordered" style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'" width="100%">
  ...
  <?php
    ...
    $kantor= $row['kantor'];
	  ...
	  $query = "SELECT * FROM permohonan_analisa_kredit WHERE status='KAKproses' and kantor_pemohon='$kantor' OR status='KAKproses2' and kantor_pemohon='$kantor' order by tanggal_input DESC"; 
