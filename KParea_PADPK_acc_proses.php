...
<form method="post" action="KParea_PADPK_save_acc_proses.php?kode_permintaan=<?php echo $kode_permintaan; ?>" enctype="multipart/form-data">
	  <table style="font-size: 18px">
		  ...
		  <td style="padding-right: 30px">Tambahkan Keterangan</td>
			  <td>:</td>
			<td style="padding-left: 10px"><textarea type="text" style="width: 400px;height: 100px"class="form-control" type="text" name="keterangan" placeholder="Tambahkan Keterangan"></textarea></td>
		  </tr>  
		  <tr>
