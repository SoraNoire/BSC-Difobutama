...
$status="Permintaan Pembatalan by HC";
$status2="Pembatalan Disetujui Audit"
?>
<div class="table-responsive">
	<table class="table" id="HCPD">
	<thead>
	...
	<td style="border: 2px solid black;text-align: center"><a class="btn btn-success" href="KParea_PM_VIonly_<?php echo($kantor)?>.php?kode_bayar=<?php echo $datapenagihanmobile['kode_bayar']?>" target="_BLANK">DETAIL</a></td>
	</tr>
	<?php
	$no++;
	}
