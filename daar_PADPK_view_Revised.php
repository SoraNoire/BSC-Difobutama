<div class="table-responsive" border="1" width="100%" style="margin-bottom: 20px">
 <table class="table table-bordered" style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'" width="100%">
  ...
  $query = "SELECT * FROM permohonan_analisa_kredit WHERE status='revised' and kantor_analis='$kantor' and nama_analis='$identitas'"; 
  ...
  while($data = mysqli_fetch_array($sql)){
	...
	echo "<td align='center'><a href='daar_PADPK_viewer_only.php?kode_permintaan=".$data['kode_permintaan']."' class='btn btn-default'><span class='glyphicon glyphicon-eye-open'></span></a></td>";
