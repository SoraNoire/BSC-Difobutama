...
<form method="post" action="AOarea_PADPK_save_edit.php?kode_permintaan=<?php echo $kode_permintaan; ?>" enctype="multipart/form-data">
      ...
      <a href="AOarea_PADPK.php" class="btn btn-warning" onclick="javascript:history.back()"><span class="glyphicon glyphicon-remove-sign"> Cancel</span></a>
</form>
  </div>
