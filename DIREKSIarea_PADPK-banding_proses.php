...
<div style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">
  <div class="col-lg-9" style="background-color:mistyrose">
    <h1 align="center"><u>Buat Keputusan Perbandingan</u></h1>
    <h4 align="center"><u><b>Nomor : <?php echo($row['kode_permintaan'])?></b></u></h4>
<form method="post" action="DIREKSIarea_PADPK-banding_save_proses.php?kode_permintaan=<?php echo $kode_permintaan; ?>" enctype="multipart/form-data">
	  <table style="font-size: 18px">
		  <tr>
			  <td style="padding-top: 30px"><u><b>Informasi Persetujuan Dokumen</b></u></td>
		  </tr>
		  <tr>
		    <td style="padding-right: 30px;padding-bottom: 20px">Input Nilai Persetujuan</td>
			  <td style="padding-bottom: 20px">:</td>
			<td style="padding-left: 10px;padding-bottom: 20px"><input type="text" style="width: 400px"class="form-control" type="text" name="newplafond" placeholder="Hanya Angka"></input></td>
		  </tr>
		  <tr>
		  <td style="padding-right: 30px">Tambahkan Keterangan</td>
			  <td>:</td>
			<td style="padding-left: 10px"><textarea type="text" style="width: 400px;height: 100px"class="form-control" type="text" name="keterangan" placeholder="Tambah Keterangan"></textarea></td>
		  </tr>  
		  <tr>
	  ...
	  <br></br>
      <input type="submit" class="btn btn-success" value="Buat Keputusan Banding">
      <a href="DIREKSIarea_PADPK.php" class="btn btn-warning" onclick="javascript:history.back()"><span class="glyphicon glyphicon-remove-sign"> Cancel</span></a>
</form>
  </div>
