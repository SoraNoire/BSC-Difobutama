...
<div style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">
  ...
  <div class="col-lg-3" align="center" style="border: solid;font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif'; padding: inherit; background: rgba(113,236,234,0.74)">
	<?php echo "<a href='daar_PADPK_confirm.php?kode_permintaan=".$kode_permintaan."' class='btn btn-success'><span class='glyphicon glyphicon-ok'> Berkas Diterima</span></a>";
	?>
	<?php echo "<a href='daar_PADPK.php' class='btn btn-warning' onclick='javascript:history.back()'><span class='glyphicon glyphicon-backward'> Back</span></a>";
	?>
   </div>
</div>
</body>
