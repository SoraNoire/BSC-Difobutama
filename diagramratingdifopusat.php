...
$bulan= date('m');
  $tahun= date('Y');
  $no=1;
  $jumlah= "SELECT rating, COUNT( * ) AS total FROM rating GROUP BY rating"; 
  $rata2= "SELECT AVG(rating) AS ratarata from rating";
...
<head>
	...
	function drawChart() {
		...
		var chart = new google.visualization.BarChart(document.getElementById('chart_ratingdifopusat'));
...
<body>
    ...
    <div id="chart_ratingdifopusat"></div>
	<div>
