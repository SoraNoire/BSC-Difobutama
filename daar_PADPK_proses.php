...
<form method="post" action="daar_PADPK_save_proses.php?kode_permintaan=<?php echo $kode_permintaan; ?>" enctype="multipart/form-data">
	  <table style="font-size: 18px">
		  ...
		  <td style="padding-right: 30px">Tambahkan Keterangan</td>
			  <td>:</td>
			<td style="padding-left: 10px"><textarea type="text" style="width: 400px;height: 100px"class="form-control" type="text" name="keterangan" placeholder="Input Keterangan Acc"></textarea></td>
		  </tr>  
		  <tr>
      ...
      <a href="daar_PADPK.php" class="btn btn-warning" onclick="javascript:history.back()"><span class="glyphicon glyphicon-remove-sign"> Cancel</span></a>
</form>
  </div>
