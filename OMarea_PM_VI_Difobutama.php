...
<center>
	...
	<?php echo "<a href='OMarea_PM_VI_Ppembatalan.php?kode_bayar=".$kode_bayar."' class='btn btn-warning'><span class='glyphicon glyphicon-remove-sign'> TERUSKAN KE AUDIT UNTUK PEMBATALAN </span></a>";
	?>
	<?php echo "<a href='OMarea_PM.php' class='btn btn-danger' onclick='javascript:history.back()'><span class='glyphicon glyphicon-backward'> Back</span></a>";
	?>
