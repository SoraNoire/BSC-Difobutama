...
<link href="css/bootstrap.min.css" rel="stylesheet" type="text/css">
	...
	<body style="background-color: darkblue;color: aliceblue;padding-top: 80px">
		<div>
		<?php
		include('dbcon.php');
		...
		$kantor=$row['kantor'];
		?>
		<form action="DIREKSIarea_RollBackLaporandifo.php" method="post" name="postform">
		...
		<?php
			...
			include('LaporanMingguan_DifobutamaRollBack.php');
			}
		}
		else{
