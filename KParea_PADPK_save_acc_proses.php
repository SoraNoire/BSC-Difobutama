...
$status 	 = 'acc2';
$zero    	 = '';
$informasi	 = 'Data Telah Disetujui Kepala Analis';
...
Hai, Kami Informasikan Ada Data Baru Yang Telah Disetujui Kepala Analis. Berikut Informasinya :    <br><br>
...
<body style="font-family:Verdana, Geneva, sans-serif;font-size:12px;">
<table width="100%" cellspacing="0" cellpadding="0" align="center" style="padding:20px;border:dashed 1px #333;"><tr><td>
Hai, Data Anda Sudah di Setujui Oleh Kepala Analis. Berikut Informasinya :    <br><br>
		<div style="float:left; width:150px; margin-bottom:5px;">Kode Permintaan</div>
		<div style="float:left;"><strong>'.$kode_permintaan.'</strong></div>
		<div style="clear:both"></div>
		<div style="float:left; width:150px; margin-bottom:5px;">Nama A.O</div>
...
if(($newplafond<1000000)){?>
		...
		<?php }else{
	$query = "UPDATE permohonan_analisa_kredit SET status='".$status."',plafond='".$newplafond."' WHERE kode_permintaan='".$kode_permintaan."'";
	...
	if($query){	
		...
		require_once('function_mailer.php');
					...
					smtp_mail($to_BM, $subject_dir, $message_dir, '', '', 0, 0, true);
