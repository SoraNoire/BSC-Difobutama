...
<head>
	...
	<body>
		<H1 align="center" style="font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif';color: rgba(16,35,247,1.00)" class="animated jackInTheBox">Status Pengajuan Kredit Saya</H1>
<div class="container" style="font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif';background: rgba(255,252,252,1.00);width: 100%">
...
<table class="table">
  ...
  $tahun= date('Y');
  $no=1;
  $jumlahSP= "SELECT * from permohonan_analisa_kredit WHERE nama_ao='$nama' ORDER BY tanggal_input DESC"; 
...
<div class="container" style="width: auto">
	...
	<!-- Modal -->
	<div id="myModal" class="modal" role="dialog" style="width: auto">
