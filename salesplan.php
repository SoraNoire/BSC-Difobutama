...
<div class="col-sm-12" style="background: rgba(253,249,249,1.00)">
	...
	<div style="padding: 0 15px;">
      ...
      <h1>D.S.A.R</h1>
      <h4 class="animated fadeInLeftBig" style="animation-duration: 5s">Daily Sales Activity Report</h4>
      ...
      -->
      <div id="view"><?php include "viewsp.php"; ?></div>
</div>
          ...
          <div class="modal-body">
            ...
            <form id="form">
              <div class="form-group">
                <label>Kode D.S.A.R</label>
                <input type="text" class="form-control" id="kode_sp" name="kode_sp" value="<?php echo sprintf($tanggal.$bulan.$tahun.$jam.$menit.$detik ."-".$mysamplekantor.$mysamplepenempatan ."/".$mysamplenik."/".$bulan."/".$tahun);?>"readonly>
              </div>
              <div class="form-group">
                <label>Uraian D.S.A.R</label>
                <textarea type="text" class="form-control" id="uraian_aktivitas" name="uraian_aktivitas" placeholder="Masukkan Uraian Aktivitas" ></textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="no_tlp_nasabah" name="no_tlp_nasabah" placeholder="No. Telepon Nasabah" >
              </div>
              <div class="form-group">
                <label>Alamat</label>
				...
				<div class="form-group">
                <label>Lokasi</label>
                <input name="lokasi_sp" type="text" style="margin-top: 2px" class="form-control" placeholder="Link Lokasi" id="lokasi_sp"><span></span></td><td><button type="button" class="btn-group-justified" onclick="getLocation()">Generate Location</button></td>
              </div>
              <div class="form-group">
                <label>Foto</label>
                ...
                <input type="file" class="form-control" id="foto" value="image">
              </div>
			<div class="form-group">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" id="data-kode_sp">
    ...
    <script src="js/ajaxSP.js"></script>
    <script src="js/ajaxSP2.js"></script>
</body>
</html>
