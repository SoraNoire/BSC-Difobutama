...
<div style="padding: 0 15px;">
      <div class="table-responsive">
        <table class="table table-bordered">
          ...
          $sql = $pdo->prepare("SELECT * FROM sales_plan_bm WHERE id_bm='$session_id' ORDER BY kodesp DESC LIMIT ".$limit_start.",".$limit);
...
function hapus(no){
	...
	$("#data-kodesp").val(kodesp);
        ...
        ?>
          <li><a href="salesplanBM.php">First</a></li>
          <li><a href="salesplanBM.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
        <?php
        }
        ?>
        ...
        ?>
          <li<?php echo $link_active; ?>><a href="salesplanBM.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php
        }
        ?>
        ...
        ?>
          <li><a href="salesplanBM.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
          <li><a href="salesplanBM.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
        <?php
        }
        ?>
      </ul>
