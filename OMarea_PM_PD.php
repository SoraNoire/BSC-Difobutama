...
$status="Permintaan Pembatalan by OM";
$status2="Pembatalan Disetujui Audit"
?>
<div class="table-responsive">
	<table class="table" id="OMPD">
	<thead>
	<tr style="border: 2px solid black; text-align: center" align="center">
		...
		<th style="border: 2px solid black;vertical-align: middle; text-align: center"><b>Detail</b></th>
	</tr>
	</thead>
	<?php
	$penagihan_mobile= "SELECT * FROM penagihan_mobile WHERE kantor='$kantor' and status_bayar='$status' or kantor='$kantor' and status_bayar='$status2'";	
	...
	<td style="border: 2px solid black;text-align: center"><a class="btn btn-success" href="OMarea_PM_VIonly_<?php echo($kantor)?>.php?kode_bayar=<?php echo $datapenagihanmobile['kode_bayar']?>" target="_BLANK">DETAIL</a></td>
	</tr>
	<?php
	$no++;
	}
