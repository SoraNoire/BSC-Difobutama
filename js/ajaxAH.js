$(document).ready(function(){
	...
	$("#btn-simpan").click(function(){ // Ketika tombol simpan di klik
		...
		data.append('lokasi_kegiatan', $("#lokasi_kegiatan").val()); 
		data.append('keterangan_kegiatan', $("#keterangan_kegiatan").val()); 
		...
		$.ajax({
			url: 'AktivitasHarian_proses_simpan.php', // File tujuan
	...
	$("#btn-ubah").click(function(){ // Ketika tombol ubah di klik
		...
		data.append('kode_kegiatan', $("#kode_kegiatan").val());
		data.append('kegiatan', $("#kegiatan").val()); // Ambil data jenis kelamin
		data.append('lokasi_kegiatan', $("#lokasi_kegiatan").val()); // Ambil data telepon
		data.append('keterangan_kegiatan', $("#keterangan_kegiatan").val()); // Ambil data alamat
		...
		$.ajax({
			url: 'AktivitasHarian_proses_ubah.php', // File tujuan
			type: 'POST', // Tentukan type nya POST atau GET
			data: data, // Set data yang akan dikirim
			processData: false,
			contentType: false,
	...
	$("#btn-hapus").click(function(){ // Ketika tombol hapus di klik
		...
		$.ajax({
			url: 'AktivitasHarian_proses_hapus.php', // File tujuan
			type: 'POST', // Tentukan type nya POST atau GET
			data: data, // Set data yang akan dikirim
			processData: false,
			contentType: false,
