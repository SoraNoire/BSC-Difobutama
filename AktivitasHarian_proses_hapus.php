...
$sqlcek = $pdo->prepare("SELECT * FROM aktivitas_harian WHERE kode_kegiatan=:kode_kegiatan");
...
if(is_file("imgaktivitasharian/".$data['foto_kegiatan'])) // Jika foto ada
	unlink("imgaktivitasharian/".$data['foto_kegiatan']); // Hapus file fotonya yang ada di folder foto

// Query untuk menghapus data siswa berdasarkan NIS yang dikirim
$sql = $pdo->prepare("DELETE FROM aktivitasharian WHERE kode_kegiatan=:kode_kegiatan");
