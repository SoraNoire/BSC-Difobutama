...
<div style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">
  ...
  <div class="col-lg-3" align="center" style="border: solid;font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif'; padding: inherit; background: rgba(113,236,234,0.74)">
	<?php echo "<a href='daar_PADPK_proses.php?kode_permintaan=".$kode_permintaan."' class='btn btn-success'><span class='glyphicon glyphicon-check'> Proses</span></a>";
	?>
	<?php echo "<a href='daar_PADPK_revised.php?kode_permintaan=".$kode_permintaan."' class='btn btn-warning'><span class='glyphicon glyphicon-book'> Revise</span></a>";
	?>
	<?php echo "<a href='daar_PADPK_rejected.php?kode_permintaan=".$kode_permintaan."' class='btn btn-danger'><span class='glyphicon glyphicon-remove'> Reject</span></a>";
	?>
	<?php echo "<a href='daar_PADPK.php' class='btn btn-info' onclick='javascript:history.back()'><span class='glyphicon glyphicon-backward'> BACK</span></a>";
	?>
   </div>
</div>
</body>
