...
<center>
	...
	<?php echo "<a href='AIarea_PM_VI_Ppembatalan.php?kode_bayar=".$kode_bayar."' class='btn btn-warning'><span class='glyphicon glyphicon-remove-sign'> SETUJUI PEMBATALAN </span></a>";
	?>
	<?php echo "<a href='AIarea_PM.php' class='btn btn-danger' onclick='javascript:history.back()'><span class='glyphicon glyphicon-backward'> Back</span></a>";
	?>
