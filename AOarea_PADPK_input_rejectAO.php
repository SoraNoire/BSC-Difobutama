...
<body>
  ...
  <div class="table table-responsive">		
	<br/>
	<button type="button" style="position: absolute" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#myModalnasabah2">Pembatalan</button>
 
	<!-- Modal nasabah-->
	<div id="myModalnasabah2" class="modal fade" role="dialog" style="background: rgba(0,0,0,0.86);">
...
<div class="modal-body">
		...
		<tr>
			...
			<th style="text-align: center">NIK KTP NASABAH</th>
		...
		<?php
			...
			$nama_ao=$row['nama_karyawan'];
			  ...
			  $nik_nasabah	 	= $dataN['id_nasabah'];
	?>
	<tr>
	<td style="text-align: center;;border: 2px solid black"><?php echo $no ?></td>
	<td style="text-align: center;;border: 2px solid black"><?php echo $nik_nasabah ?></td>
	<td style="text-align: center;;border: 2px solid black"><?php echo $nama_nasabah ?></td>
	<td align="center"><a href="AOarea_PADPK_input_new_rejectAO.php?id_nasabah=<?php echo $dataN['id_nasabah']?>"><span class="btn btn-info">GUNAKAN</span></a></td>
	</tr>
	<?php
	$no++;
	}
