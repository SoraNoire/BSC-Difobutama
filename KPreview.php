...
<script type="text/javascript" src="js/jquery.min.js"></script>
	...
	<body>
		...
		$kantor=$row['kantor'];
		?>
		<form action="KParea.php" method="post" name="postform">
		...
		<?php
			...
			<?php
			$query=mysqli_query($con, "SELECT * FROM laporan_penagihan WHERE kantor='$kantor' and tanggal_penagihan between '$tanggal_awal' and '$tanggal_akhir'");
			}
		?>
		</p>
