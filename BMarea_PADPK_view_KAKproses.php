 ...
 <table class="table table-bordered" style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'" width="100%">
  ...
  <?php
    ...
    $kantor= $row['kantor'];
	  ...
	  $query = "SELECT * FROM permohonan_analisa_kredit WHERE status='KAKproses' AND kantor_pemohon='$kantor' OR status='KAKproses2' AND kantor_pemohon='$kantor'"; 
	...
	echo "<td align='center'><a href='BMarea_PADPK_viewer_only.php?kode_permintaan=".$data['kode_permintaan']."' class='btn btn-default'><span class='glyphicon glyphicon-eye-open'></span></a></td>";
    echo "</tr>";
  }
  ?>
	</table>
