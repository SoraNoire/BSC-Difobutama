...
<div class="table-responsive">
	<table class="table" id="penagihan_mobile">
	<thead>
	...
	<?php
	$penagihan_mobile= "SELECT * FROM penagihan_mobile WHERE kantor='$kantor' and status_bayar='$status'";	
	...
	<td style="border: 2px solid black;text-align: center"><a class="btn btn-success" href="KParea_PM_VI_<?php echo($kantor)?>.php?kode_bayar=<?php echo $datapenagihanmobile['kode_bayar']?>" target="_BLANK">DETAIL</a></td>
	</tr>
	<?php
	$no++;
	}
