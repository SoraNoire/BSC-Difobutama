...
<form method="post" action="DIREKSIarea_PADPK_save_revised.php?kode_permintaan=<?php echo $kode_permintaan; ?>" enctype="multipart/form-data">
	  ...
	  <br></br>
      <input type="submit" class="btn btn-success" value="Kembalikan Ke AO">
