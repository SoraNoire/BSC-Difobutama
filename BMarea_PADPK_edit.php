...
<form method="post" action="BMarea_PADPK_save_edit.php?kode_permintaan=<?php echo $kode_permintaan; ?>" enctype="multipart/form-data">
	  <table style="font-size: 18px">
		  ...
		  <tr>
			  ...
			  <td>:</td>
			  <td style="padding-left: 10px"><input type="text" style="width: 200px"class="form-control" type="text" name="nama_ao" value="<?php echo($row['nama_ao'])?>"></input></td>
		  </tr>
		  <tr><tr>
