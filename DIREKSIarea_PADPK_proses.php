...
<form method="post" action="DIREKSIarea_PADPK_save_proses.php?kode_permintaan=<?php echo $kode_permintaan; ?>" enctype="multipart/form-data">
	  ...
	  <br></br>
      <input type="submit" class="btn btn-success" value="ACC">
