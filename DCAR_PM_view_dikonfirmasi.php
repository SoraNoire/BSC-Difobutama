...
$(document).ready(function() {
    $('#penagihan_mobile_konfirm').DataTable();
} );
</script>
<?php
include('dbcon.php');
...
<div class="table-responsive">
	<table class="table" id="penagihan_mobile_konfirm">
	<thead>
	<tr style="border: 2px solid black; text-align: center" align="center">
		...
		<th style="border: 2px solid black;vertical-align: middle; text-align: center"><b>Nama Teller</b></th>
	</tr>
	</thead>
	<?php
	$penagihan_mobile= "SELECT * FROM penagihan_mobile WHERE id_penagih='$id_penagih' and status_bayar='$status'";	
	...
	$penagihanmobile_namateller		= $datapenagihanmobile['nama_teller'];
	?>
	<tr>
	...
	<td style="border: 2px solid black"><?php echo $penagihanmobile_namateller ?></td>
	</tr>
	<?php
	$no++;
	}
