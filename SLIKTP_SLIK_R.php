...
<h1 align="center" style="color:blueviolet" class="animated slideInLeft">Permintaan SLIK</h1>
  ...
  <li class="active"><a href="#req" data-toggle="tab">AO REQUEST</a></li>
  <li><a href="#proses" data-toggle="tab">SELESAI UPLOAD</a></li>
  </ul>
<div class="tab-content" style="padding-top: 1%">
  <div class="tab-pane active" id="req"><?php include('SLIKTP_SLIK_R_VPros.php')?></div>
  <div class="tab-pane" id="proses"><?php include ('SLIKTP_SLIK_R_VClear.php')?></div>
</div>
</div>
