<div class="table-responsive" border="1" width="100%" style="margin-bottom: 20px">
 <table class="table table-bordered" style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'" width="100%">
  ...
  $query = "SELECT * FROM activity_pe WHERE status='delete' and nik='$owner'"; 
  ...
  while($data = mysqli_fetch_array($sql)){
    ...
    echo "<td align='center'><a href='PEarea_activity_recover.php?kode=".$data['kode']."' class='btn btn-info'><span class='glyphicon glyphicon-refresh'></span></a></td>";
    echo "<td align='center'><a href='PEarea_activity_delete_permanent.php?kode=".$data['kode']."' class='btn btn-danger'><span class='glyphicon glyphicon-erase'></span></a></td>";
    echo "</tr>";
  }
  ?>
	</table>
