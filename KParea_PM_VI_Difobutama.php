...
<center>
	<h3>Apakah Anda Ingin Membatalkan Pembayaran Ini?</h3>
	<?php echo "<a href='KParea_PM_VI_Ppembatalan.php?kode_bayar=".$kode_bayar."' class='btn btn-warning'><span class='glyphicon glyphicon-remove-sign'> TERUSKAN KE AUDIT UNTUK PEMBATALAN </span></a>";
	?>
	<?php echo "<a href='KParea_PM.php' class='btn btn-danger' onclick='javascript:history.back()'><span class='glyphicon glyphicon-backward'> Back</span></a>";
	?>
	<h4 style="color: red">*PASTIKAN TRANSAKSI YG DIBATALKAN ADALAH TRANSAKSI YG SEBENARNYA</h4> 
</center>
</body>
</html>