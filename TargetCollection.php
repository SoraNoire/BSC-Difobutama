...
<body>
	<div>
		<?php
		include('TargetCollection_Input.php')
		?>
	</div>
	<div align="center" >
	<span style="font-size: 50px;font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif';color: darkblue" class="w3-animate-fading infinite">INPUT TARGET PENAGIHAN</span>
	</div>
	<div>
		<?php
		include('TargetCollection_ved.php')
		?>
	</div>
</body>
</html>