...
<center>
	<h3>Apakah Anda Ingin Mengkonfirmasi Pembayaran Ini?</h3>
	<?php echo "<a href='KASIR_INVOICE_confirm.php?kode_bayar=".$kode_bayar."' class='btn btn-success'><span class='glyphicon glyphicon-ok'> KONFIRMASI </span></a>";
	?>
	<?php echo "<a href='KASIR_Home.php' class='btn btn-danger' onclick='javascript:history.back()'><span class='glyphicon glyphicon-backward'> Back</span></a>";
	?>
	<h4 style="color: red">#Konfirmasi Pembayaran Hanya/Jika Uang Sudah Di Terima / Transfer </h4> 
</center>
</body>
</html>