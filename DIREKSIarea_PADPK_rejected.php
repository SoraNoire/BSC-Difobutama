...
<div style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">
  <div class="col-lg-9" style="background-color:mistyrose">
    <h1 align="center"><u>UBAH INFORMASI PENGAJUAN SURVEY</u></h1>
    <h4 align="center"><u><b>Nomor : <?php echo($row['kode_permintaan'])?></b></u></h4>
<form method="post" action="DIREKSIarea_PADPK_save_rejected.php?kode_permintaan=<?php echo $kode_permintaan; ?>" enctype="multipart/form-data">
	  <table style="font-size: 18px">
		  <tr>
			  <td style="padding-top: 30px"><u><b>Informasi Pengembalian Dokumen</b></u></td>
		  </tr>
		  <tr>
	  ...
	  <br></br>
      <input type="submit" class="btn btn-danger" value="Tolak Berkas Pengajuan ini">
