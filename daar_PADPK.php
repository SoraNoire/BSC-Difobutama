...
<div class="tab-content" style="padding-top: 5px">
  <div class="tab-pane active" id="draft"><?php include('daar_PADPK_view_permintaan.php')?></div>
  <div class="tab-pane" id="proses1"><?php include ('daar_PADPK_view_dokumenditerima.php')?></div>
  <div class="tab-pane" id="acc3"><?php include ('daar_PADPK_view_ACC3.php')?></div>
  <div class="tab-pane" id="acc2"><?php include ('daar_PADPK_view_ACC2.php')?></div>
  <div class="tab-pane" id="acc"><?php include ('daar_PADPK_view_ACC.php')?></div>
  <div class="tab-pane" id="revised"><?php include ('daar_PADPK_view_Revised.php')?></div>
  <div class="tab-pane" id="reject"><?php include ('daar_PADPK_view_Rejected.php')?></div>
</div>
</div>
