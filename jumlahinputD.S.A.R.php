...
<head>
	<body>
		<H1 align="center" style="font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif';color: rgba(16,35,247,1.00)" class="animated jackInTheBox">D.S.A.R RANKING</H1>
		<H4 align="center">Total Penginputan Bulanan</H4>
...
<table class="table-responsive" width="100%" style="margin-bottom: 20px;font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif';font-size: 20px;font-style: oblique">
  ...
  $tahun= date('Y');
  $no=1;
  $jumlahSP= "SELECT nama_karyawan, COUNT( * ) AS total FROM sales_plan WHERE month(tanggal_sp)=$bulan and year(tanggal_sp)=$tahun GROUP BY nama_karyawan ORDER BY total DESC LIMIT 10";
