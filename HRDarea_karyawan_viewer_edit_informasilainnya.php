...
<div class="container" style="background:rgba(244,230,231,1.00);font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', 'serif';width: 100%">
  <div class="container" style="width: 100%;border: 10px double black">
	...
	<form method="post" action="HRDarea_karyawan_viewer_edit_informasilainnya_save.php?nik=<?php echo $nik; ?>" enctype="multipart/form-data">
	<table style="font-size: 18px">
		<tr>
		    <td style="padding-right: 30px">No. KTP</td>
			<td>:</td>
		    <td style="padding-left: 10px">
			  <input class="form-control" value="<?php echo($row['no_ktp'])?>" id="no_ktp" name="no_ktp"></input>
		    </td>
		</tr>
		<tr>
		    <td style="padding-right: 30px">No. NPWP</td>
			<td>:</td>
		    <td style="padding-left: 10px">
			  <input class="form-control" value="<?php echo($row['no_npwp'])?>" id="no_npwp" name="no_npwp"></input>
		    </td>
		</tr>
		<tr>
		    <td style="padding-right: 30px">No. Rek. Aktif</td>
			<td>:</td>
		    <td style="padding-left: 10px">
			  <input class="form-control" value="<?php echo($row['no_rek'])?>" id="no_rek" name="no_rek"></input>
		    </td>
		</tr>
		<tr>
		    <td style="padding-right: 30px">Bank</td>
			<td>:</td>
		    <td style="padding-left: 10px">
			  <input class="form-control" value="<?php echo($row['bank'])?>" id="bank" name="bank"></input>
		    </td>
		</tr>
