...
<body style="padding-top: 70px;background-color: aliceblue">
			...
			<div>
				...
				<?php include "OMarea_sidenav.php"?>
			</div>
...
<div class="tab-content" style="padding-top: 5px">
  <div class="tab-pane active" id="tunai"> <?php include ('OMarea_PM_PBDK.php')?> </div>
  <div class="tab-pane" id="transfer"><?php include ('OMarea_PM_PSDK.php')?></div>
  <div class="tab-pane" id="dikonfirmasi"><?php include ('OMarea_PM_PD.php')?></div>
</div>
</div>
