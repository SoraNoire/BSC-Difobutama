<div class="table-responsive" border="1" width="100%" style="margin-bottom: 20px">
 <table class="table table-bordered" style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, 'sans-serif'" width="100%">
  ...
  $query = "SELECT * FROM news WHERE kantor='$kantor' and jenis='Pengumuman' ORDER BY tanggal_berlaku DESC"; 
  ...
  while($data = mysqli_fetch_array($sql)){
    ...
    echo "<td align='center'><a href='HRDarea_News_viewer.php?no_surat=".$data['no_surat']."' class='btn btn-warning'><span class='glyphicon glyphicon-eye-open'></span></a></td>";
    echo "<td align='center'><a href='HRDarea_News_hapus.php?no_surat=".$data['no_surat']."' class='btn btn-danger'><span class='glyphicon glyphicon-erase'></span></a></td>";
    echo "</tr>";
  }
  ?>
	</table>
