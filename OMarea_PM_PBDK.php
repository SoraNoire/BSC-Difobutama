...
<div class="table-responsive">
	...
	<td style="border: 2px solid black;text-align: center"><a class="btn btn-success" href="OMarea_PM_VI_<?php echo($kantor)?>.php?kode_bayar=<?php echo $datapenagihanmobile['kode_bayar']?>" target="_BLANK">DETAIL</a></td>
	</tr>
	<?php
	$no++;
	}
